...
Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the maintainers via the contact method listed in [SECURITY.md](SECURITY.md) or by opening a private report. All complaints will be reviewed and investigated promptly and fairly.
...
2. **Warning** — a warning with consequences for continued behaviour, including no interaction with the people involved for a specified period.
